...
/// \ingroup Layer
/// \defgroup set_layer_permission set_layer_permission node
///
/// \brief This node changes the layer permission.
///
...
/// \param [in] read_only To set the layer as non editable.
/// \param [in,out] layer The layer in which to set the permission.
USD_NODEDEF_DECL
void set_layer_permission(const bool read_only
    ...
    USDNODE_DOC_ICON("set_layer_permission", "set_layer_permission", "usd.svg");
